...
import { deleteTransaction, getTransactions } from "../../../_service/transactions";
                ...
                {transactions.length > 0 ? (
                  transactions.map((transaction) => (
                    <tr key={transaction.id} className="border-b dark:border-gray-700">
                      ...
                      <td className="px-4 py-3">{transaction.book_id}</td>
                      ...
                      <td className="px-4 py-3 flex items-center justify-end relative">
                        ...
                        {openDropdownId === transaction.id && (
                          <div
                            ...
                            style={{ top: "100%", right: "0" }} // This style is likely causing the dropdown to appear below the table row.
                          >
                            <div className="py-1">
                              <button
