            ...
            <ul className="pt-5 mt-5 space-y-2 borderT border-gray-200 dark:border-gray-700">
              ...
              <li>
                <button
                  ...
                  className="flex w-full items-center p-2 text-base font-medium bg-red-200 text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group"
                >                
